...
# from division.config.settings import SECRET_KEY, ALGORITHM
...
# # from division.session import get_session
...
#             if not username:
#                 raise HTTPException(
#                     status_code=status.HTTP_401_UNAUTHORIZED, detail="Invalid Session ID"
#                 )
